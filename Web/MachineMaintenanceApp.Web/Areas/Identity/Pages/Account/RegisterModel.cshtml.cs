namespace MachineMaintenanceApp.Web.Areas.Identity.Pages.Account
{
    using System;
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var company = this.companyService.GetByName<CompanyIdViewModel>(this.Input.CompanyName);
                ...
                if (result.Succeeded)
                {
                    ...
                    await this.userManager.AddToRoleAsync(user, this.Input.Position.ToString());
