namespace MachineMaintenanceApp.Web.ViewModels.Administration.UnplannedRepairs.Details
{
    using System;
    ...
    public class AdminUnplannedRepairsDetailsViewModel : IMapFrom<UnplannedRepair>
    {
